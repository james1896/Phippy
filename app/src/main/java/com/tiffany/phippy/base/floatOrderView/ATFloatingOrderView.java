package com.tiffany.phippy.base.floatOrderView;
 ...
 *
 ...
 sellOrderView.setVisibility(View.GONE);
...
public class ATFloatingOrderView extends LinearLayout implements View.OnClickListener {
    ...
    public ATFloatingOrderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mView = LayoutInflater.from(context).inflate(R.layout.float_order_progress_view, null);
        addView(mView);
        initView();
