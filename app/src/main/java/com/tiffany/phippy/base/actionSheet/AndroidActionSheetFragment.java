package com.tiffany.phippy.base.actionSheet;
...
public class AndroidActionSheetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        realView=inflater.inflate(R.layout.actionsheet_view_actionsheet, container, false);
        initViews(realView);
    ...
    private void initViews(View view) {
        ...
        if (getArguments().getInt("type")==1) {
            ...
            for (int i=0;i<getArguments().getStringArray("items").length;i++) {
                final int i_=i;
                View viewChild= LayoutInflater.from(getActivity()).inflate(R.layout.actionsheet_adapter_share, null, false);
